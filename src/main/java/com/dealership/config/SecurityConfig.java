// src/main/java/com/dealership/config/SecurityConfig.java
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/vehicles/*/restock").hasRole("ADMIN")
                .requestMatchers("/api/vehicles/*/transactions").hasRole("ADMIN")
